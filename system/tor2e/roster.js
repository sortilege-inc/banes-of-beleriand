// system/tor2e/roster.js — the Player-heroes this browser keeps: several, one current. State
...
window.TorRoster = (function () {
  const KEY = ((window.VttConfig || {}).storagePrefix || 'sortilege-vtt-tor2e') + ':site:roster';
  ...
  const gen = () => 'ph-' + Math.random().toString(36).slice(2, 10);
