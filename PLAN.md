...
| M2 | The site: the books (outline, reader, sidebars, tables, the rules icons), the adventures, the Bestiary and the Loremaster characters, the dice, search | |
| M3 | The Loremaster's page: Adventure tracker (the 13 arcs as modules), Company, Inspector, Bestiary (put in a scene), Tables (rolled on), Dice, Rules & Book, Log, Campaign; the table and the player's page wired | |
