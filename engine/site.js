...
(function () {
  ...
  // The deployment's name, as the Loremaster's table (engine/app.js) and the map table
  // (engine/vtt.js) already take it: an instance names its pages in engine/config.js, never in
  // upstream HTML.
