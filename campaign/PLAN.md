...
| 32 | The live Foundry world (read over the foundryrestapi.com relay, 2026-09-25) was **not** taken for the Company's sheets | Its five heroes are the same actors as the May exports, last changed 2025-07-26: nothing about the heroes has advanced, only live state (Lily Hope 13 and 1 Shadow, Marigold Hope 15) and **Már's Treasure 0 → 90**. The sheets keep the May exports until the owner rules on Már's Treasure or newer sheets turn up. |
