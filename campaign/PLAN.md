...
| M3 | here | **The campaign's content** — the Company, the chronicle, the people, places and the Loremaster's state, written into `campaign/docs/`, `campaign/dsl/` and `campaign/pack/` (O3) | **In progress** — chronicle done: all nine sessions (2025-05-06 → 2025-09-09) written as chapters `docs/chronicle/01…09`, voice approved on the pilot; build *chronicle 9, campaign build: OK*. Next: Company pages + sheets, people, places, the Loremaster seed |
